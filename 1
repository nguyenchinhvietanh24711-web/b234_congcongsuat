...
<head>
    ...
    <!-- MathJax để hiển thị công thức vật lý chuẩn xác -->
    ...
    <style>
        ...
        * { box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; margin: 0; padding: 0; }
        ...
        @media (max-width: 600px) {
            ...
            .instruction-content h2 { font-size: 1.5rem; }
            .instruction-content li { font-size: 0.85rem; }
            .btn { width: 100%; padding: 0.9rem; }
            .nav-buttons { flex-direction: column; gap: 8px !important; }
